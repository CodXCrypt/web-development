...
songIndex = 0;
songs = ['./assets/music/Titliaan.mp3', './assets/music/dontstartnow.mp3']; // object storing paths for audio objects
...
songArtists = ['Afsana Khan', 'Dua Lipa']; // object storing track artists
songTitles = ["Titliaan", "Don't Start Now"]; // object storing track titles
